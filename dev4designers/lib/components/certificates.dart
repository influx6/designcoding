...
class CertificateExplorer extends StatefulWidget {
  @override
  _CertificateExploreState createState() => _CertificateExploreState();
}

class _CertificateExploreState extends State<CertificateExplorer> {
